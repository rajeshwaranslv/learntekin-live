...
export default class Testimonials extends Component {
  ...
  render() {
    const testimonials = [
      ...
      { 
        name: "Harishini. V", 
        role: "Software Engineer at VEE technology ", 
        img: "assets/img/testimonials/testimonials-6.jpg",
        message: "I am from MVIT, Madagadipet, Villupuram. Great attention to detail and excellent execution!, I got 4+ offers in my hand. " 
      },
      { 
        name: "Moniksha	M", 
        role: "PHP developer at Eventures Company Pvt.Ltd", 
        img: "assets/img/testimonials/testimonials-7.jpg",
        message: "I am from SMVC, Madagadipet, Villupuram.They exceeded all expectations. Fantastic experience!" 
      },
      // { 
    //     name: "Lisa White", 
