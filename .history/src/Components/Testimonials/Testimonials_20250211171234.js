  ...
  render() {
    const testimonials = [
...

      {
        ...
        message:
          "I am from MVIT, Madagadipet, Villupuram. Great attention to detail and excellent execution!, I got 4+ offers in my hand. ",
      },
      {
        name: "Moniksha	M",
        ...
        message:
          "I am from SMVC, Madagadipet, Villupuram. They exceeded all expectations. Fantastic experience!",
      },
      // {
      //     name: "Lisa White",
